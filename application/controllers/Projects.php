...
class Projects extends CI_Controller
{
    ...
    public function printmilestones() {
        $id = $this->input->get('id');
        ...
        $html = $this->load->view('print_files/milestones', $data, true);
        $pdf->WriteHTML($html);
        $file_name = preg_replace('/[^A-Za-z0-9]+/', '-', $data['project']['name']);
        $pdf->Output($file_name . '.pdf', 'I');
    } // change request made 5th, october 2023 emergency
