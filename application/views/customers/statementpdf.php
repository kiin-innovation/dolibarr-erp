...
<div class="invoice-box">
        ...
        <tr>
            <td class="myco">
                <!--<img src="<?php //echo base_url('userfiles/company/' . $this->config->item('logo')) ?>"-->
                     <!--style="max-width:260px;">  // Dropped on 15 oct 2023-->
                <img src="https://erp.zeolf.com/userfiles/company/16450326532115553946.png" alt="logo"
    ...
    <table class="plist" cellpadding="0" cellspacing="0">
        ...
        foreach ($list as $row) {
            ...
            $balance = $row['debit'] - $row['credit'] + $balance; // added on 4/10/2023 emergency request for account statement
