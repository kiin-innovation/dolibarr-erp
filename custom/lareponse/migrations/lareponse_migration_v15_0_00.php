...
/**
 * Class LaReponseMigrationV15_0_00		Class to manage migration for version 15.0.00
 *
 * This class will create all tables previously created through .sql files.
 * This will be the new initialisation file.
 */
class LaReponseMigrationV15_0_00 extends AbstractMigration
{
	public $version = "15.0.00"; // Version of execution
	public $description = "Migration for the version 15.0.00 of LaReponse module"; // Description
	public $name = "lareponseMigration_15.0.00"; // Migration name
