...
/**
 * Class LaReponseMigrationV19_1_01       Class to manage migration for version 19.1.01
 *
 * This class will create all tables previously created through .sql files.
 * This will be the new initialisation file.
 */
class LaReponseMigrationV19_1_01 extends AbstractMigration
{
	public $version = "19.1.01"; // Version of execution
	public $description = "Migration for the version 19.1.01 of LaReponse module"; // Description
	public $name = "lareponseMigration_19.1.01"; // Migration name
