...
/**
 * Class LaReponseMigrationV16_1_00		Class to manage migration for version 16.1.00
 *
 * This class will create all tables previously created through .sql files.
 * This will be the new initialisation file.
 */
class LaReponseMigrationV16_1_00 extends AbstractMigration
{
	public $version = "16.1.00"; // Version of execution
	public $description = "Migration for the version 16.1.00 of LaReponse module"; // Description
	public $name = "lareponseMigration_16.1.00"; // Migration name
