...
/**
 * Class LaReponseMigrationV14_1_00		Class to manage migration for version 14.0.00
 *
 * This class will create all tables previously created through .sql files.
 * This will be the new initialisation file.
 */
class LaReponseMigrationV14_1_00 extends AbstractMigration
{
	public $version = "14.1.00"; // Version of execution
	public $description = "Migration for the version 14.1.00 of LaReponse module"; // Description
	public $name = "lareponseMigration_14.1.00"; // Migration name
