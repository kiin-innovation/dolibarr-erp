...
/**
 * \file    test/functional/H2G2FunctionalTest.php
 * \ingroup h2g2
 ...
 * @package Testh2g2
 */
class H2G2FunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/h2g2/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('h2g2/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/h2g2/admin/about.php');
		$this->authenticate();
		return $this->assertContains('h2g2/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('h2g2widget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modH2G2_H2G2Triggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modH2G2_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
