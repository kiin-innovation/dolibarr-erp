...
if ($argc < 4) {// Check parameters
	...
	print "- param3 = [Type]        Type of the new (Must be a number between 0 or 3 (exemple: 0->Success / 1->Utility / 2->Warning / 3->Danger)\n";
	print "- param4 = [Entity]      Entity where news will be publish\n";
...
$codes = array(448312, 448313, 448314, 448315);
...
$actioncomm->datef = strtotime('+48 hours', dol_now());
